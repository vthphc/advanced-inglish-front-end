<script setup lang="ts">
	...
	const formattedDate = computed(() => {
		return new Date(props.transaction.createdAt).toLocaleDateString(
			"vi-VN",
			{
				year: "numeric",
				month: "long",
...
<template>
	<div
		class="rounded-md shadow-md flex items-center justify-center p-4 py-8">
			...
			<Card class="border-0 shadow-lg">
				<CardHeader class="text-center pb-4">
					...
					<CardTitle class="text-2xl"
						>Nâng Cấp Tài Khoản Thành
						Công</CardTitle
					>
					<CardDescription class="text-base">
						Tài khoản của bạn đã được nâng
						cấp từ Free lên Premium. Bạn giờ
						đây có thể truy cập tất cả các
						tính năng premium!
					</CardDescription>
				</CardHeader>
				<CardContent class="space-y-6">
					...
					<div class="space-y-4">
						...
						<div
							...
							<div
								...
								<div>
									<h4
										class="font-medium text-purple-900">
										Làm
										Việc
										Nhóm
									</h4>
					...
					<div class="grid grid-cols-2 gap-x-4">
						<NuxtLink href="/account">
							<Button
								class="w-full rounded-md border-primary">
								Đến Trang Cá
								Nhân
								<ArrowRight
									class="w-4 h-4 ml-2" />
