...
<template>
    <div class="mb-8" :data-question="`${index}`">
        ...
        <div class="space-y-4">
            ...
            <div class="mt-4">
                <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    <h3 class="font-medium mb-2">Your Recording:</h3>
                    <audio
        ...
        <div class="my-4 space-x-4 flex flex-row">
            <Button :disabled="!isPremium" @click="showAnswer = !showAnswer"
            ...
            <div class="relative place-self-center">
                ...
                >
                    Tính năng Premium: Click để AI transcribe audio của bạn
                </div>
            </div>
            <AiTranscription
