<script setup lang="ts">
	...
	import ReadingListeningInstructions from "~/components/tests/reading_listening/ReadingListeningInstructions.vue";
	...
	import SpeakingInstructions from "~/components/tests/speaking/SpeakingInstructions.vue";
