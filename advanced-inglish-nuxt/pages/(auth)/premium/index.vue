<script setup lang="ts">
	...
	const features: Feature[] = [
		...
		},
		{
			...
			free: "Phân tích Speaking từ A.I",
			premium: "Phân tích Speaking từ A.I",
			freeIncluded: false,
			premiumIncluded: true,
		},
	];
		...
		<div class="max-w-6xl mx-auto">
			...
			<div class="text-center mb-12">
				...
				<p
					...
					Bắt đầu miễn phí và nâng cấp khi bạn cần
					thêm tính năng. Tất cả các gói đều bao
					gồm các tính năng cốt lõi.
				</p>
			</div>
			...
			<div class="grid md:grid-cols-2 gap-8 mb-12">
				...
				<Card
					...
					<CardHeader class="text-center pb-8">
						...
						<CardDescription
							class="text-gray-600"
							>Hoàn hảo cho người mới
							bắt đầu</CardDescription
						>
						<div class="mt-4">
							<span
				...
				<Card
					...
					<div
						...
						<Badge
							class="bg-purple-600 text-white px-4 py-1"
							>Phổ biến nhất</Badge
						>
					</div>
					<CardHeader class="text-center pb-8">
						<div
							class="flex justify-center mb-4">
							<div
								class="p-3 bg-purple-100 rounded-full">
								<Zap
			...
			<div class="mt-12 grid md:grid-cols-3 gap-6">
				<div class="text-center p-6">
					...
					<p class="text-sm text-gray-600">
						Bảo mật cấp doanh nghiệp với cam
						kết hoạt động 99.9%
					</p>
				</div>
				<div class="text-center p-6">
					...
					<p class="text-sm text-gray-600">
						Làm việc cùng nhau mượt mà với
						các công cụ cộng tác thời gian
						thực
					</p>
				</div>
				<div class="text-center p-6">
					...
					<p class="text-sm text-gray-600">
						Nhận trợ giúp khi cần với đội
						ngũ hỗ trợ chuyên dụng
					</p>
				</div>
			</div>
		</div>
