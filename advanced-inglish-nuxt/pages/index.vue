...
<template>
    ...
    <div class="flex flex-col items-center justify-center min-h-screen p-6">
      <div class="bg-white shadow-lg rounded-lg p-8 max-w-lg w-full">
        ...
        <div class="bg-gray-50 p-4 rounded-lg mb-6">
          <h3 class="font-medium text-gray-800 mb-2">Your Progress</h3>
          <div class="w-full bg-gray-200 rounded-full h-2.5">
            <div class="bg-primary h-2.5 rounded-full" style="width: 45%"></div>
          </div>
          <p class="text-sm text-gray-600 mt-2">45% complete</p>
        </div>

        <div class="grid grid-cols-2 gap-4">
          <UButton class="bg-primary text-white">Continue Learning</UButton>
          <UButton variant="outline" class="border-primary text-primary"
            >Practice</UButton
          >
          <UButton variant="outline" class="border-primary text-primary"
            >Vocabulary</UButton
  ...
  <div v-else class="flex justify-center items-center h-screen">
    <div class="m-auto flex flex-col items-center">
      <motion.p v-bind="fadeInPropsFn()" class="font-bold text-center text-xl">
        Welcome to
      ...
      <ClientOnly>
        ...
        <motion.div v-bind="fadeInPropsFn(5)">
          ...
          >
            ...
            >
              <NuxtLink to="/login"><span> Đã có tài khoản? </span></NuxtLink>
            </p>
            <motion.div
