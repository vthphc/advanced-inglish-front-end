<script setup lang="ts">
	...
	const fetchFlashcards = async () => {
		try {
			...
			error.value =
				"Không thể tải danh sách thẻ học. Vui lòng thử lại sau.";
		} finally {
	...
	async function onSubmit(event: FormSubmitEvent<FormData>) {
		try {
			...
			toast.add({
				title: "Lỗi",
				description:
					"Không thể tạo thẻ học. Vui lòng thử lại.",
				color: "error",
			});
		} finally {
		...
		<div class="">
			...
			<div
				...
				<p class="text-gray-500">
					Chưa có thẻ học nào. Hãy bắt đầu tạo một
					số thẻ học!
				</p>
			</div>
		...
		<Dialog>
			...
			<DialogContent>
				<DialogHeader>
					...
					<DialogDescription>
						Tạo một thẻ học mới để bắt đầu
						luyện tập tiếng Anh của bạn.
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
					<DialogClose />
